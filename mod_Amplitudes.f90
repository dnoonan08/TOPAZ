...
SUBROUTINE EvalSqAmp_qqb_ttb_pho(MomExt,Ehat,PDFFac,LO_Res_UnPol)
use ModMisc
use ModParameters
implicit none
real(8) :: y13,y14,y15,y23,y24,y25,y34,y35,y45,M1sq,M2sq,M3sq,MAsymSq
real(8) :: PDFFac(:),MomExt(:,:),EHat
complex(8) :: LO_Res_UnPol
    ...
    LO_Res_UnPol =+ 1d0/Q_Top**2*( M1sq*(Q_up)**2 + M2sq*(Q_top**2) + M3sq*(Q_top*Q_up) )*PDFFac(1) & 
                  + 1d0/Q_Top**2*( M1sq*(Q_dn)**2 + M2sq*(Q_top**2) + M3sq*(Q_top*Q_dn) )*PDFFac(2)
    

print *, "Ehat",Ehat
print *, "yijs",y13,y14,y15,y23,y24,y25,y34,y35,y45  
